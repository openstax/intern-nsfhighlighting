    ...
    return(
      ...
      <Row style={{textAlign:"center"}}>
        ...
        <div>
          ...
          <Row>
            <Col md={4}>
              <Button style={styles.button} key={Settings.tags[0]} onClick={this.toggleTag.bind(this, Settings.tags[0])} bsSize="small" bsStyle={this.state[Settings.tags[0]]}>{Settings.tags[0]}</Button>
            </Col>

            <Col md={4}>
              <div style={{paddingLeft:"0px"}}>
              <Button style={styles.button} key={Settings.tags[1]} onClick={this.toggleTag.bind(this, Settings.tags[1])} bsSize="small" bsStyle={this.state[Settings.tags[1]]}>{Settings.tags[1]}</Button>
              </div>
            </Col>

            <Col md={4}>
              <Button style={styles.button} key={Settings.tags[2]} onClick={this.toggleTag.bind(this, Settings.tags[2])} bsSize="small" bsStyle={this.state[Settings.tags[2]]}>{Settings.tags[2]}</Button>
            </Col>
          </Row>
          <br></br>
          <div style={{paddingLeft:"17px"}} >
